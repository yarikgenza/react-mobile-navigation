...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactPagesCore = __webpack_require__(193);

	var _SettingsMainPageContainer = __webpack_require__(240);

	var _SettingsMainPageContainer2 = _interopRequireDefault(_SettingsMainPageContainer);
	...
	function pageStoreModel(status, zIndex, prevPageId) {
	  return Object.assign({}, (0, _reactPagesCore.actionPageStoreModel)(status, zIndex), {
	...
	var stackId = 'stackId';
	var pageId = 'pageId';
	var pageState = pageStoreModel(_reactPagesCore.PageStatusTypesEnum.OPENED, 1, undefined);
	...
	ReactDOM.render(React.createElement(
	  ...
	  React.createElement(
	    ...
	    { style: style },
	    React.createElement(
	      _reactPagesCore.StandardPageComponent,
	      (_React$createElement = {
	        pageState: pageState,
	        stackId: stackId,
	        pageId: pageId,
	        pagingActions: {}
	      }, _defineProperty(_React$createElement, 'pageId', MAIN_PAGE_ID), _defineProperty(_React$createElement, 'pageWidth', width), _defineProperty(_React$createElement, 'pageHeight', height), _React$createElement),
	      React.createElement(_SettingsMainPageContainer2.default, null)
	    )
	  )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mainPageReducers = __webpack_require__(192);

	var rootReducer = (0, _redux.combineReducers)({
		mainPageReducers: _mainPageReducers.mainPageReducers
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.mainPageReducers = mainPageReducers;

	var _reactPagesCore = __webpack_require__(193);

	var _stackActionPages = __webpack_require__(224);

	function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }

	var initialState = (_initialState = {}, _defineProperty(_initialState, _stackActionPages.systemPagesTypesEnum.ACTION_SHEET_PAGE_ID, (0, _reactPagesCore.actionPageStoreModel)(_reactPagesCore.PageStatusTypesEnum.CLOSED)), _defineProperty(_initialState, _stackActionPages.systemPagesTypesEnum.COMBOBOX_PAGE_ID, (0, _reactPagesCore.actionPageStoreModel)(_reactPagesCore.PageStatusTypesEnum.CLOSED)), _initialState);

	// TODO: simplify?
	function mainPageReducers() {
		var state = arguments.length <= 0 || arguments[0] === undefined ? initialState : arguments[0];
		var action = arguments[1];

		switch (action.type) {
			case _stackActionPages.InternalPagingActionTypes.INTERNAL_OPEN_PAGE:
			case _stackActionPages.InternalPagingActionTypes.INTERNAL_OPENING_PAGE:
			case _stackActionPages.InternalPagingActionTypes.INTERNAL_OPENING_PAGE_DONE:
			case _stackActionPages.InternalPagingActionTypes.INTERNAL_GOING_BACK:
			case _stackActionPages.InternalPagingActionTypes.INTERNAL_GO_BACK:
			case _stackActionPages.InternalPagingActionTypes.INTERNAL_GOING_BACK_DONE:
				return Object.assign({}, state, (0, _stackActionPages.internalPagesReducers)(state, action));
			default:
				return state;
		}
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.DirectionEnum = exports.actionPageStoreModel = exports.PageStatusTypesEnum = exports.Interpolation = exports.CustomPageBody = exports.PageWrapper = exports.ShadowPageComponent = exports.StandardPageComponent = undefined;

	var _StandardPageComponent = __webpack_require__(194);

	var _ShadowPageComponent = __webpack_require__(202);

	var _PageWrapper = __webpack_require__(205);

	var _CustomPageBody = __webpack_require__(206);

	var _Interpolation = __webpack_require__(207);

	var _pageStatusTypes = __webpack_require__(198);

	var PageStatusTypesEnum = _interopRequireWildcard(_pageStatusTypes);

	var _actionPageStoreModel = __webpack_require__(223);

	var _directionTypes = __webpack_require__(199);

	var DirectionEnum = _interopRequireWildcard(_directionTypes);

	function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

	exports.StandardPageComponent = _StandardPageComponent.StandardPageComponent;
	exports.ShadowPageComponent = _ShadowPageComponent.ShadowPageComponent;
	exports.PageWrapper = _PageWrapper.PageWrapper;
	exports.CustomPageBody = _CustomPageBody.CustomPageBody;
	exports.Interpolation = _Interpolation.Interpolation;
	exports.PageStatusTypesEnum = PageStatusTypesEnum;
	exports.actionPageStoreModel = _actionPageStoreModel.actionPageStoreModel;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.StandardPageComponent = undefined;

	var _react = __webpack_require__(1);

	var _react2 = _interopRequireDefault(_react);

	var _standardPageStyles = __webpack_require__(195);

	var _visabilityStatuses = __webpack_require__(201);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var propTypes = {
	  children: _react2.default.PropTypes.element.isRequired,
	  pageId: _react2.default.PropTypes.any,
	  pageState: _react2.default.PropTypes.any,
	  pageHeight: _react2.default.PropTypes.number,
	  pageWidth: _react2.default.PropTypes.number,
	  pagingActions: _react2.default.PropTypes.any,
	  stackId: _react2.default.PropTypes.any,
	  translateValue: _react2.default.PropTypes.number
	};

	var defaultProps = {};

	var StandardPageComponent = exports.StandardPageComponent = function StandardPageComponent(_ref) {
	  var translateValue = _ref.translateValue;
	  var pageState = _ref.pageState;
	  var children = _ref.children;
	  var stackId = _ref.stackId;
	  var pageId = _ref.pageId;
	  var pagingActions = _ref.pagingActions;
	  var pageHeight = _ref.pageHeight;
	  var pageWidth = _ref.pageWidth;
	  var status = pageState.status;
	  var zIndex = pageState.zIndex;
	  var direction = pageState.direction;

	  if (!(0, _visabilityStatuses.shouldRender)(status)) {
	    return null;
	  }
	  var standardPageStyle = (0, _standardPageStyles.getStandardPageStyle)(zIndex, direction, status, translateValue);
	  return _react2.default.createElement(
	    'div',
	    { style: standardPageStyle },
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.getStandardPageStyle = getStandardPageStyle;

	var _animationPosition = __webpack_require__(196);

	var _styles = __webpack_require__(200);

	function getStandardPageStyle(zIndex, direction, status, translateValue) {
	  var transform = (0, _animationPosition.getTranslate3dByDirection)(status, direction, translateValue);
	  return Object.assign({}, _styles.baseContainerStyles, {
	    zIndex: zIndex
	  }, transform);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.getTranslate3dByDirection = getTranslate3dByDirection;
	...
	function getTranslate3dByDirection(status, direction, value) {
	  switch (status) {
	    ...
	    case PageStatusTypesEnum.CLOSING:
	      switch (direction) {
	        ...
	        default:
	          if (process.env.NODE_ENV !== 'production') {
	            (0, _invariant2.default)(true, 'Property "direction" should be "HORIZONTAL" or "VERTICAL"');
	          }
	          return getTransform('translate3d(0, 0, 0)');
	      }
	    ...
	    default:
	      if (process.env.NODE_ENV !== 'production') {
	        (0, _invariant2.default)(true, 'Property "status" is out of range.');
	      }
	      return getTransform('translate3d(0, 0, 0)');
	  }
	}
...
/***/ function(module, exports) {
	...
	var PREPARE_TO_OPEN = exports.PREPARE_TO_OPEN = 'PREPARE_TO_OPEN';
	var OPENING = exports.OPENING = 'OPENING';
	var OPENED = exports.OPENED = 'OPENED';
	var PREPARE_TO_CLOSE = exports.PREPARE_TO_CLOSE = 'PREPARE_TO_CLOSE';
	var CLOSING = exports.CLOSING = 'CLOSING';
...
/***/ function(module, exports) {
	...
	var customPageBodyStyle = exports.customPageBodyStyle = {
	  position: 'absolute',
	  width: '100%',
	  height: '100%'
	};

	var baseContainerStyles = exports.baseContainerStyles = {
	  position: 'absolute',
	  width: '100%',
	  height: '100%'
	};

	var baseDarkScreenStyles = exports.baseDarkScreenStyles = {
	  position: 'absolute',
	  top: 0,
	  bottom: 0,
	  left: 0,
	...
	var baseContentWrapperStyles = exports.baseContentWrapperStyles = {
	  position: 'absolute',
	  bottom: 0,
	...
	var pageWrapperStyles = exports.pageWrapperStyles = {
	  position: 'absolute',
	  width: '100%',
	  height: '100%',
	  overflow: 'hidden'
	...
	function isPageOpen(status) {
	  switch (status) {
	    ...
	    case PageStatusTypesEnum.PREPARE_TO_OPEN:
	      return false;
	    default:
	      (0, _invariant2.default)(true, 'Porperty "status" in "isPageOpen" function is out of range');
	      return true;
	  }
	}

	function isPageVisible(status) {
	  switch (status) {
	    case PageStatusTypesEnum.OPENING:
	    case PageStatusTypesEnum.OPENED:
	    case PageStatusTypesEnum.PREPARE_TO_CLOSE:
	    ...
	    case PageStatusTypesEnum.PREPARE_TO_OPEN:
	      return false;
	    default:
	      (0, _invariant2.default)(true, 'Porperty "status" in "isPageVisible" function is out of range');
	      return true;
	  }
	}

	function shouldRender(status) {
	  return status !== PageStatusTypesEnum.CLOSED;
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.ShadowPageComponent = undefined;
	...
	var _shadowPageStyles = __webpack_require__(204);
	...
	var propTypes = {
	  ...
	  stackId: _react2.default.PropTypes.any,
	  pagingActions: _react2.default.PropTypes.any,
	  onShadowClick: _react2.default.PropTypes.any,
	  children: _react2.default.PropTypes.element.isRequired
	};

	var defaultProps = {};

	var ShadowPageComponent = exports.ShadowPageComponent = (_class = function (_React$Component) {
	  _inherits(ShadowPageComponent, _React$Component);

	  function ShadowPageComponent() {
	    _classCallCheck(this, ShadowPageComponent);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(ShadowPageComponent).apply(this, arguments));
	  }

	  _createClass(ShadowPageComponent, [{
	    key: 'onShadowClick',
	    value: function onShadowClick() {
	      var onShadowClick = this.props.onShadowClick;
	    ...
	    key: 'renderFullShadowPage',
	    value: function renderFullShadowPage(shadowPageStyle, pageState, zIndex, status) {
	      var direction = pageState.direction;
	      var _props = this.props;
	      var stackId = _props.stackId;
	      var pageId = _props.pageId;
	      var pagingActions = _props.pagingActions;
	      var translateValue = _props.translateValue;
	      var children = _props.children;

	      var shadowPageContentStyle = (0, _shadowPageStyles.getShadowPageContentStyle)(direction, zIndex, status, translateValue);
	      var darkBackgroundStyle = (0, _shadowPageStyles.getDarkBackgroundStyle)(zIndex, status, translateValue);
	      return _react2.default.createElement(
	        'div',
	        { style: shadowPageStyle },
	        _react2.default.createElement('div', { style: darkBackgroundStyle, onClick: this.onShadowClick }),
	        _react2.default.createElement(
	          'div',
	          { style: shadowPageContentStyle },
	          _react2.default.cloneElement(_react2.default.Children.only(children), {
	            pageState: pageState,
	            stackId: stackId,
	            pageId: pageId,
	    ...
	    value: function render() {
	      ...
	      var shadowPageStyle = (0, _shadowPageStyles.getShadowPageStyle)(zIndex);
	      return this.renderFullShadowPage(shadowPageStyle, pageState, zIndex, status);
	    }
	  }]);

	  return ShadowPageComponent;
	}(_react2.default.Component), (_applyDecoratedDescriptor(_class.prototype, 'onShadowClick', [_autobindDecorator2.default], Object.getOwnPropertyDescriptor(_class.prototype, 'onShadowClick'), _class.prototype)), _class);


	ShadowPageComponent.propTypes = propTypes;
	ShadowPageComponent.defaultProps = defaultProps;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.getDarkBackgroundStyle = getDarkBackgroundStyle;
	exports.getShadowPageContentStyle = getShadowPageContentStyle;
	exports.getShadowPageStyle = getShadowPageStyle;
	...
	function getDarkBackgroundStyle(zIndex, status, translateValue) {
	  var halfOpacity = 0.3;
	  var translateMaxValue = 100;
	  var dynamicOpacity = halfOpacity * translateValue / translateMaxValue;
	  return Object.assign({}, _styles.baseDarkScreenStyles, {
	    zIndex: zIndex + 1,
	    visibility: (0, _visabilityStatuses.isPageVisible)(status) ? 'visible' : 'hidden',
	    opacity: halfOpacity - dynamicOpacity
	  });
	}

	function getShadowPageContentStyle(direction, zIndex, status, translateValue) {
	  var transform = (0, _animationPosition.getTranslate3dByDirection)(status, direction, translateValue);
	  return Object.assign({}, _styles.baseContentWrapperStyles, {
	    zIndex: zIndex + 2
	  }, transform);
	}

	function getShadowPageStyle(zIndex) {
	  return Object.assign({}, _styles.baseContainerStyles, {
	    zIndex: zIndex
	  });
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PageWrapper = exports.PageWrapper = function PageWrapper(_ref) {
	  var children = _ref.children;
	  return _react2.default.createElement(
	    'div',
	    { style: _styles.pageWrapperStyles },
	    children
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.CustomPageBody = undefined;
	...
	var CustomPageBody = exports.CustomPageBody = function CustomPageBody(_ref) {
	  var zIndex = _ref.zIndex;
	  var children = _ref.children;

	  var style = _extends({}, _styles.customPageBodyStyle, {
	    zIndex: zIndex
	  });
	  return _react2.default.createElement(
	    'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Interpolation = undefined;
	...
	var _springConfigs = __webpack_require__(222);
	...
	var propTypes = {
	  setPageStatus: _react2.default.PropTypes.any,
	  pageActionTransitionEndHandler: _react2.default.PropTypes.any,
	  pageState: _react2.default.PropTypes.any,
	  children: _react2.default.PropTypes.element.isRequired
	};
	...
	var Interpolation = exports.Interpolation = function (_React$Component) {
	  _inherits(Interpolation, _React$Component);

	  function Interpolation() {
	    _classCallCheck(this, Interpolation);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Interpolation).apply(this, arguments));
	  }
	  ...
	  _createClass(Interpolation, [{
	    ...
	    value: function render() {
	      ...
	      var status = this.props.pageState.status;

	      var springValue = (0, _visabilityStatuses.isPageOpen)(status) ? INTERP_BEGIN : INTERP_END;
	      return _react2.default.createElement(
	        _reactMotion.Motion,
	        {
	          style: { translateValue: (0, _reactMotion.spring)(springValue, _springConfigs.fadeSpringConfig) },
	          onRest: this.props.pageActionTransitionEndHandler
	        },
	        function (interp) {
	          return _react2.default.cloneElement(_react2.default.Children.only(_this2.props.children), {
	            translateValue: interp.translateValue,
	            pageState: _this2.props.pageState
	          });
	        }
	      );
	    }
...
/***/ function(module, exports) {
	...
	var fadeSpringConfig = exports.fadeSpringConfig = {
	  stiffness: 450,
	  damping: 34,
	  precision: 1
	};
...
/***/ function(module, exports) {
	...
	exports.actionPageStoreModel = actionPageStoreModel;
	function actionPageStoreModel(status) {
	  var zIndex = arguments.length <= 1 || arguments[1] === undefined ? 0 : arguments[1];
	  var direction = arguments.length <= 2 || arguments[2] === undefined ? undefined : arguments[2];
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.internalPagesReducers = exports.InternalPagingActionTypes = exports.internalPagingActions = exports.systemPagesTypesEnum = exports.ComboboxCustomOptionModel = exports.ComboboxPage = exports.ComboboxOptionModel = exports.ActionSheetOptionModel = exports.ActionSheetPage = exports.comboBoxPageStoreModel = exports.actionSheetPageStoreModel = undefined;

	var _actionSheetPageStoreModel = __webpack_require__(225);

	var _comboBoxPageStoreModel = __webpack_require__(226);

	var _ActionSheet = __webpack_require__(227);

	var _ComboBox = __webpack_require__(231);

	var _systemPagesTypesEnum = __webpack_require__(230);

	var systemPagesTypesEnum = _interopRequireWildcard(_systemPagesTypesEnum);

	var _internalPagingActions = __webpack_require__(236);

	var internalPagingActions = _interopRequireWildcard(_internalPagingActions);

	var _internalPagingActionTypes = __webpack_require__(237);

	var InternalPagingActionTypes = _interopRequireWildcard(_internalPagingActionTypes);

	var _internalPagesReducers = __webpack_require__(238);

	function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

	exports.actionSheetPageStoreModel = _actionSheetPageStoreModel.actionSheetPageStoreModel;
	exports.comboBoxPageStoreModel = _comboBoxPageStoreModel.comboBoxPageStoreModel;
	exports.ActionSheetPage = _ActionSheet.ActionSheetPage;
	exports.ActionSheetOptionModel = _ActionSheet.ActionSheetOptionModel;
	exports.ComboboxOptionModel = _ComboBox.ComboboxOptionModel;
	exports.ComboboxPage = _ComboBox.ComboboxPage;
	exports.ComboboxCustomOptionModel = _ComboBox.ComboboxCustomOptionModel;
	exports.systemPagesTypesEnum = systemPagesTypesEnum;
	exports.internalPagingActions = internalPagingActions;
	exports.InternalPagingActionTypes = InternalPagingActionTypes;
	exports.internalPagesReducers = _internalPagesReducers.internalPagesReducers;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.actionSheetPageStoreModel = actionSheetPageStoreModel;

	var _reactPagesCore = __webpack_require__(193);

	function actionSheetPageStoreModel(status, zIndex) {
	  return Object.assign({}, (0, _reactPagesCore.actionPageStoreModel)(status, zIndex), {
	    items: [],
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.comboBoxPageStoreModel = comboBoxPageStoreModel;

	var _reactPagesCore = __webpack_require__(193);

	function comboBoxPageStoreModel(status, zIndex) {
	  return Object.assign({}, (0, _reactPagesCore.actionPageStoreModel)(status, zIndex), {
	    items: [],
	    selectedItem: undefined,
	    textField: ''
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.ActionSheetPage = undefined;

	var _ActionSheetPage = __webpack_require__(228);

	exports.ActionSheetPage = _ActionSheetPage.ActionSheetPage;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ActionSheetListComponent = __webpack_require__(229);
	...
	var propTypes = {
	  ...
	  stackId: _react2.default.PropTypes.oneOfType([_react2.default.PropTypes.number, _react2.default.PropTypes.string]),
	  pageId: _react2.default.PropTypes.oneOfType([_react2.default.PropTypes.number, _react2.default.PropTypes.string]),
	  onShadowClick: _react2.default.PropTypes.func,
	  pagingActions: _react2.default.PropTypes.objectOf(_react2.default.PropTypes.func)
	};

	var defaultProps = {};

	var ActionSheetPage = exports.ActionSheetPage = (_class = function (_React$Component) {
	  _inherits(ActionSheetPage, _React$Component);

	  function ActionSheetPage() {
	    _classCallCheck(this, ActionSheetPage);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(ActionSheetPage).apply(this, arguments));
	  }
	  ...
	  _createClass(ActionSheetPage, [{
	    ...
	    value: function setPageStatus() {
	      ...
	      switch (stackData.status) {
	        case _reactPagesCore.PageStatusTypesEnum.PREPARE_TO_OPEN:
	          // case PageSideTypesEnum.GOING_TO_MAIN:
	          stackData.pagingActions.openingPage(stackData.stackId, stackData.pageId, systemPagesTypesEnum.ACTION_SHEET_PAGE_ID);
	          return;
	        case _reactPagesCore.PageStatusTypesEnum.PREPARE_TO_CLOSE:
	          // case PageSideTypesEnum.GOING_TO_COVER:
	          stackData.pagingActions.goingBack(stackData.stackId, stackData.pageId, systemPagesTypesEnum.ACTION_SHEET_PAGE_ID);
	          return;
	        default:
	          return;
	      }
	    ...
	    key: 'pageActionTransitionEndHandler',
	    value: function pageActionTransitionEndHandler() {
	      switch (this.props.pageState.status) {
	        case _reactPagesCore.PageStatusTypesEnum.OPENING:
	          this.props.pagingActions.openingPageDone(this.props.stackId, this.props.pageId, systemPagesTypesEnum.ACTION_SHEET_PAGE_ID);
	          return;
	        case _reactPagesCore.PageStatusTypesEnum.CLOSING:
	          this.props.pagingActions.goingBackDone(this.props.stackId, this.props.pageId, systemPagesTypesEnum.ACTION_SHEET_PAGE_ID);
	          return;
	        default:
	          (0, _invariant2.default)(true, 'ERROR');
	          return;
	      }
	    }
	  }, {
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          _reactPagesCore.ShadowPageComponent,
	          {
	            stackId: this.props.stackId,
	            onShadowClick: this.onShadowClick
	          },
	          _react2.default.createElement(_ActionSheetListComponent.ActionSheetListComponent, null)
	        )
	      );
	    }
	  }]);
	...
	}(_react2.default.Component), (_applyDecoratedDescriptor(_class.prototype, 'onShadowClick', [_autobindDecorator2.default], Object.getOwnPropertyDescriptor(_class.prototype, 'onShadowClick'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'setPageStatus', [_autobindDecorator2.default], Object.getOwnPropertyDescriptor(_class.prototype, 'setPageStatus'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'pageActionTransitionEndHandler', [_autobindDecorator2.default], Object.getOwnPropertyDescriptor(_class.prototype, 'pageActionTransitionEndHandler'), _class.prototype)), _class);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.ActionSheetListComponent = undefined;
	...
	var ActionSheetListComponent = exports.ActionSheetListComponent = function ActionSheetListComponent() {
	  return _react2.default.createElement(
	    'div',
	    null,
	    'ActionSheetList Options'
	  );
	};
...
/***/ function(module, exports) {
	...
	var COMBOBOX_PAGE_ID = exports.COMBOBOX_PAGE_ID = 'combobox-page-id';
	var ACTION_SHEET_PAGE_ID = exports.ACTION_SHEET_PAGE_ID = 'action-sheet-page-id';
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.ComboboxPage = undefined;

	var _ComboboxPage = __webpack_require__(232);

	exports.ComboboxPage = _ComboboxPage.ComboboxPage;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ComboboxComponent = __webpack_require__(233);
	...
	var ComboboxPage = exports.ComboboxPage = (_class = function (_React$Component) {
	  _inherits(ComboboxPage, _React$Component);

	  function ComboboxPage() {
	    _classCallCheck(this, ComboboxPage);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(ComboboxPage).apply(this, arguments));
	  }
	  ...
	  _createClass(ComboboxPage, [{
	    ...
	    value: function setPageStatus() {
	      ...
	      switch (stackData.status) {
	        case _reactPagesCore.PageStatusTypesEnum.PREPARE_TO_OPEN:
	          // case PageSideTypesEnum.GOING_TO_MAIN:
	          stackData.pagingActions.openingPage(stackData.stackId, stackData.pageId, systemPagesTypesEnum.COMBOBOX_PAGE_ID);
	          return;
	        case _reactPagesCore.PageStatusTypesEnum.PREPARE_TO_CLOSE:
	          // case PageSideTypesEnum.GOING_TO_COVER:
	          stackData.pagingActions.goingBack(stackData.stackId, stackData.pageId, systemPagesTypesEnum.COMBOBOX_PAGE_ID);
	          return;
	        default:
	          return;
	      }
	    ...
	    value: function pageActionTransitionEndHandler() {
	      switch (this.props.pageState.status) {
	        case _reactPagesCore.PageStatusTypesEnum.OPENING:
	          this.props.pagingActions.openingPageDone(this.props.stackId, this.props.pageId, systemPagesTypesEnum.COMBOBOX_PAGE_ID);
	          return;
	        case _reactPagesCore.PageStatusTypesEnum.CLOSING:
	          this.props.pagingActions.goingBackDone(this.props.stackId, this.props.pageId, systemPagesTypesEnum.COMBOBOX_PAGE_ID);
	          return;
	        default:
	          (0, _invariant2.default)(true, 'ERROR');
	          return;
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(_ComboboxComponent.ComboboxComponent, {
	  ...
	  return ComboboxPage;
	}(_react2.default.Component), (_applyDecoratedDescriptor(_class.prototype, 'setPageStatus', [_autobindDecorator2.default], Object.getOwnPropertyDescriptor(_class.prototype, 'setPageStatus'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'pageActionTransitionEndHandler', [_autobindDecorator2.default], Object.getOwnPropertyDescriptor(_class.prototype, 'pageActionTransitionEndHandler'), _class.prototype)), _class);


	ComboboxPage.propTypes = propTypes;
	ComboboxPage.defaultProps = defaultProps;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.ComboboxComponent = undefined;
	...
	var ComboboxComponent = exports.ComboboxComponent = (_class = function (_React$Component) {
	  _inherits(ComboboxComponent, _React$Component);

	  function ComboboxComponent() {
	    _classCallCheck(this, ComboboxComponent);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(ComboboxComponent).apply(this, arguments));
	  }
	  ...
	  _createClass(ComboboxComponent, [{
	    ...
	    key: 'render',
	    value: function render() {
	      var actionClassNames = (0, _classnames2.default)('combobox-action-sheet', {});
	      return _react2.default.createElement(
	        'div',
	...
	}(_react2.default.Component), (_applyDecoratedDescriptor(_class.prototype, 'onSelectItem', [_autobindDecorator2.default], Object.getOwnPropertyDescriptor(_class.prototype, 'onSelectItem'), _class.prototype)), _class);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.openingPage = openingPage;
	exports.openingPageDone = openingPageDone;
	exports.goBack = goBack;
	exports.goingBack = goingBack;
	exports.goingBackDone = goingBackDone;

	var _internalPagingActionTypes = __webpack_require__(237);

	function openPage(stackId, pageName, internalPageName, direction, zIndex) {
	  return { type: _internalPagingActionTypes.INTERNAL_OPEN_PAGE, stackId: stackId, pageName: pageName, internalPageName: internalPageName, direction: direction, zIndex: zIndex };
	}

	function openingPage(stackId, pageName, internalPageName) {
	  return { type: _internalPagingActionTypes.INTERNAL_OPENING_PAGE, stackId: stackId, pageName: pageName, internalPageName: internalPageName };
	}

	function openingPageDone(stackId, pageName, internalPageName) {
	  return { type: _internalPagingActionTypes.INTERNAL_OPENING_PAGE_DONE, stackId: stackId, pageName: pageName, internalPageName: internalPageName };
	}

	function goBack(stackId, pageName, internalPageName) {
	  return { type: _internalPagingActionTypes.INTERNAL_GO_BACK, stackId: stackId, pageName: pageName, internalPageName: internalPageName };
	}

	function goingBack(stackId, pageName, internalPageName) {
	  return { type: _internalPagingActionTypes.INTERNAL_GOING_BACK, stackId: stackId, pageName: pageName, internalPageName: internalPageName };
	}

	function goingBackDone(stackId, pageName, internalPageName) {
	  return { type: _internalPagingActionTypes.INTERNAL_GOING_BACK_DONE, stackId: stackId, pageName: pageName, internalPageName: internalPageName };
	}
...
/***/ function(module, exports) {
	...
	var INTERNAL_OPEN_PAGE = exports.INTERNAL_OPEN_PAGE = 'INTERNAL_OPEN_PAGE';
	var INTERNAL_OPENING_PAGE = exports.INTERNAL_OPENING_PAGE = 'INTERNAL_OPENING_PAGE';
	var INTERNAL_OPENING_PAGE_DONE = exports.INTERNAL_OPENING_PAGE_DONE = 'INTERNAL_OPENING_PAGE_DONE';
	var INTERNAL_GO_BACK = exports.INTERNAL_GO_BACK = 'INTERNAL_GO_BACK';
	var INTERNAL_GOING_BACK = exports.INTERNAL_GOING_BACK = 'INTERNAL_GOING_BACK';
	var INTERNAL_GOING_BACK_DONE = exports.INTERNAL_GOING_BACK_DONE = 'INTERNAL_GOING_BACK_DONE';
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.internalPagesReducers = internalPagesReducers;
	...
	var _internalPageReducers = __webpack_require__(239);
	...
	function internalPagesReducers() {
	  var state = arguments.length <= 0 || arguments[0] === undefined ? initialState : arguments[0];
	  var action = arguments[1];

	  switch (action.type) {
	    case InternalPagingActionTypes.INTERNAL_OPEN_PAGE:
	      return Object.assign({}, state, _defineProperty({}, action.internalPageName, (0, _internalPageReducers.internalPagingReducers)(state[action.internalPageName], _reactPagesCore.PageStatusTypesEnum.PREPARE_TO_OPEN, action.zIndex, action.direction)));
	    case InternalPagingActionTypes.INTERNAL_OPENING_PAGE:
	      return Object.assign({}, state, _defineProperty({}, action.internalPageName, (0, _internalPageReducers.internalPagingReducers)(state[action.internalPageName], _reactPagesCore.PageStatusTypesEnum.OPENING, state[action.internalPageName].zIndex)));
	    case InternalPagingActionTypes.INTERNAL_OPENING_PAGE_DONE:
	      return Object.assign({}, state, _defineProperty({}, action.internalPageName, (0, _internalPageReducers.internalPagingReducers)(state[action.internalPageName], _reactPagesCore.PageStatusTypesEnum.OPENED, state[action.internalPageName].zIndex)));
	    case InternalPagingActionTypes.INTERNAL_GOING_BACK:
	      return Object.assign({}, state, _defineProperty({}, action.internalPageName, (0, _internalPageReducers.internalPagingReducers)(state[action.internalPageName], _reactPagesCore.PageStatusTypesEnum.CLOSING, state[action.internalPageName].zIndex)));
	    case InternalPagingActionTypes.INTERNAL_GO_BACK:
	      return Object.assign({}, state, _defineProperty({}, action.internalPageName, (0, _internalPageReducers.internalPagingReducers)(state[action.internalPageName], _reactPagesCore.PageStatusTypesEnum.PREPARE_TO_CLOSE, state[action.internalPageName].zIndex)));
	    case InternalPagingActionTypes.INTERNAL_GOING_BACK_DONE:
	      return Object.assign({}, state, _defineProperty({}, action.internalPageName, (0, _internalPageReducers.internalPagingReducers)(state[action.internalPageName], _reactPagesCore.PageStatusTypesEnum.CLOSED, 0)));
	    default:
	      return state;
	  }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.internalPagingReducers = internalPagingReducers;

	var _reactPagesCore = __webpack_require__(193);

	function internalPagingReducers(state, actionType, zIndex, direction) {
	  switch (actionType) {
	    case _reactPagesCore.PageStatusTypesEnum.PREPARE_TO_OPEN:
	      return Object.assign({}, state, {
	        status: _reactPagesCore.PageStatusTypesEnum.PREPARE_TO_OPEN,
	        zIndex: zIndex,
	        direction: direction
	      });
	    case _reactPagesCore.PageStatusTypesEnum.OPENING:
	      return Object.assign({}, state, {
	        status: _reactPagesCore.PageStatusTypesEnum.OPENING
	      });
	    case _reactPagesCore.PageStatusTypesEnum.OPENED:
	      return Object.assign({}, state, {
	        status: _reactPagesCore.PageStatusTypesEnum.OPENED
	      });
	    case _reactPagesCore.PageStatusTypesEnum.PREPARE_TO_CLOSE:
	      return Object.assign({}, state, {
	        status: _reactPagesCore.PageStatusTypesEnum.PREPARE_TO_CLOSE
	      });
	    case _reactPagesCore.PageStatusTypesEnum.CLOSING:
	      return Object.assign({}, state, {
	        status: _reactPagesCore.PageStatusTypesEnum.CLOSING
	      });
	    case _reactPagesCore.PageStatusTypesEnum.CLOSED:
	      return Object.assign({}, state, {
	        status: _reactPagesCore.PageStatusTypesEnum.CLOSED,
	        zIndex: 0,
	        direction: undefined
	      });
	    default:
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SettingsMainPageComponent = __webpack_require__(241);

	var _stackActionPages = __webpack_require__(224);

	function mapStateToProps(state) {
		return {
			actionSheet: state.mainPageReducers[_stackActionPages.systemPagesTypesEnum.ACTION_SHEET_PAGE_ID],
			comboBox: state.mainPageReducers[_stackActionPages.systemPagesTypesEnum.COMBOBOX_PAGE_ID]
		};
	}

	function mapDispatchToProps(dispatch) {
		return {
			actionSheetActions: (0, _redux.bindActionCreators)(_stackActionPages.internalPagingActions, dispatch),
			comboBoxActions: (0, _redux.bindActionCreators)(_stackActionPages.internalPagingActions, dispatch)
		};
	}

	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_SettingsMainPageComponent.SettingsMainPageComponent);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.SettingsMainPageComponent = undefined;
	...
	var SettingsMainPageComponent = exports.SettingsMainPageComponent = (_class = function (_React$Component) {
	  _inherits(SettingsMainPageComponent, _React$Component);

	  function SettingsMainPageComponent(props) {
	    _classCallCheck(this, SettingsMainPageComponent);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(SettingsMainPageComponent).call(this, props));

	    _this.actionSheetItems = [];
	    _this.comboBoxItems = [];
	    _this.comboBoxInputPlaceholder = 'Type Here (Hardcoded)';
	  ...
	  _createClass(SettingsMainPageComponent, [{
	    key: 'openActionsheet',
	    value: function openActionsheet() {
	      this.actionSheetItems = [];
	      this.props.actionSheetActions.openPage(this.props.stackId, this.props.pageId, _stackActionPages.systemPagesTypesEnum.ACTION_SHEET_PAGE_ID, _reactPagesCore.DirectionEnum.VERTICAL, this.props.pageState.zIndex);
	    }
	  }, {
	    key: 'openCombobox',
	    value: function openCombobox() {
	      this.comboBoxItems = [];
	      this.setState({
	        comboBoxTextFilter: ''
	      });
	      this.props.comboBoxActions.openPage(this.props.stackId, this.props.pageId, _stackActionPages.systemPagesTypesEnum.COMBOBOX_PAGE_ID, _reactPagesCore.DirectionEnum.HORIZONTAL, this.props.pageState.zIndex);
	    }
	  }, {
	    key: 'onActionSheetSelect',
	    value: function onActionSheetSelect(selectedItem) {
	      if (selectedItem.key === 'licenses') {
	        this.onActionSheetCancel();
	      }
	    }
	  }, {
	    key: 'onActionSheetCancel',
	    value: function onActionSheetCancel() {
	      this.props.actionSheetActions.goBack(this.props.stackId, this.props.pageId, _stackActionPages.systemPagesTypesEnum.ACTION_SHEET_PAGE_ID);
	    }
	  }, {
	    key: 'onComboBoxSelect',
	    value: function onComboBoxSelect(selectedItem) {
	      if (selectedItem.key === 'first') {
	        this.onComboBoxCancel();
	      }
	    }
	  }, {
	    key: 'onComboBoxSelectCustom',
	    value: function onComboBoxSelectCustom(text) {
	      console.log(text, text.handler());
	    }
	  }, {
	    key: 'onComboBoxSetFilter',
	    value: function onComboBoxSetFilter(comboBoxTextFilter) {
	      this.setState({
	        comboBoxTextFilter: comboBoxTextFilter
	      });
	    }
	  }, {
	    key: 'onComboBoxCancel',
	    value: function onComboBoxCancel() {
	      this.props.comboBoxActions.goBack(this.props.stackId, this.props.pageId, _stackActionPages.systemPagesTypesEnum.COMBOBOX_PAGE_ID);
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      var COMBOBOX = 'COMBOBOX';
	      var ACTION_SHEET = 'ACTION_SHEET';
	      var actionSheetPageState = this.props.actionSheet;
	      var comboBoxPageState = this.props.comboBox;
	      var mainPageStyle = {
	      ...
	      return _react2.default.createElement(
	        _reactPagesCore.PageWrapper,
	        null,
	        _react2.default.createElement(
	          _reactPagesCore.CustomPageBody,
	          { zIndex: this.props.pageState.zIndex },
	          _react2.default.createElement(
	            'div',
	            { style: mainPageStyle },
	            _react2.default.createElement(
	        ...
	        _react2.default.createElement(_stackActionPages.ActionSheetPage, {
	        ...
	        _react2.default.createElement(_stackActionPages.ComboboxPage, {
	...
	}(_react2.default.Component), (_applyDecoratedDescriptor(_class.prototype, 'openActionsheet', [_autobindDecorator2.default], Object.getOwnPropertyDescriptor(_class.prototype, 'openActionsheet'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'openCombobox', [_autobindDecorator2.default], Object.getOwnPropertyDescriptor(_class.prototype, 'openCombobox'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'onActionSheetSelect', [_autobindDecorator2.default], Object.getOwnPropertyDescriptor(_class.prototype, 'onActionSheetSelect'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'onActionSheetCancel', [_autobindDecorator2.default], Object.getOwnPropertyDescriptor(_class.prototype, 'onActionSheetCancel'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'onComboBoxSelect', [_autobindDecorator2.default], Object.getOwnPropertyDescriptor(_class.prototype, 'onComboBoxSelect'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'onComboBoxSelectCustom', [_autobindDecorator2.default], Object.getOwnPropertyDescriptor(_class.prototype, 'onComboBoxSelectCustom'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'onComboBoxSetFilter', [_autobindDecorator2.default], Object.getOwnPropertyDescriptor(_class.prototype, 'onComboBoxSetFilter'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'onComboBoxCancel', [_autobindDecorator2.default], Object.getOwnPropertyDescriptor(_class.prototype, 'onComboBoxCancel'), _class.prototype)), _class);
	...
	SettingsMainPageComponent.propTypes = {
	  ...
	  actionSheet: _react2.default.PropTypes.any,
	  comboBox: _react2.default.PropTypes.any,
	  actionSheetActions: _react2.default.PropTypes.any,
	  comboBoxActions: _react2.default.PropTypes.any
	};
